                                                ...
                                                <div className="mt-2 space-y-2">
                                                    ...
                                                    <ul className="text-xs space-y-1 text-gray-600 dark:text-gray-400 mt-2">
                                                        <li className="flex items-center">
                                                            <span
                                                                className={`mr-1 ${formData.password.length >= 8
                                                                        ? "text-green-500"
                                                                        : "text-gray-400"
                                                                    }`}
                                                            >
                                                        ...
                                                        <li className="flex items-center">
                                                            <span
                                                                className={`mr-1 ${/[A-Z]/.test(formData.password)
                                                                        ? "text-green-500"
                                                                        : "text-gray-400"
                                                                    }`}
                                                            >
                                                        ...
                                                        <li className="flex items-center">
                                                            <span
                                                                className={`mr-1 ${/[0-9]/.test(formData.password)
                                                                        ? "text-green-500"
                                                                        : "text-gray-400"
                                                                    }`}
                                                            >
                                                        ...
                                                        <li className="flex items-center">
                                                            <span
                                                                className={`mr-1 ${/[^A-Za-z0-9]/.test(formData.password)
                                                                        ? "text-green-500"
                                                                        : "text-gray-400"
                                                                    }`}
                                                            >
