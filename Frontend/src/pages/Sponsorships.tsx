        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          <Card className="md:col-span-1">
            ...
            <CardContent className="space-y-4">
              ...
              <div className="space-y-2">
                <Label htmlFor="campaign-type" className="text-gray-900">
                  Campaign Type
                </Label>
                <Select defaultValue="all">
          ...
          <div className="md:col-span-3 space-y-4">
            <Tabs defaultValue="matches">
              <TabsList className="grid w-full grid-cols-3 bg-gray-100">
                <TabsTrigger value="matches" className="text-gray-900">
                  AI Matches
                </TabsTrigger>
                <TabsTrigger value="active" className="text-gray-900">
                  Active Deals
                </TabsTrigger>
                <TabsTrigger value="history" className="text-gray-900">
                  History
                </TabsTrigger>
              </TabsList>
                    ...
                    <div className="flex flex-col md:flex-row gap-6">
                      ...
                      <div className="flex-1 space-y-2">
                        <div className="flex flex-col md:flex-row md:items-center justify-between gap-2">
                          ...
                          <Badge className="w-fit text-lg px-3 py-1 bg-purple-100 text-purple-600">
                            98% Match
                          </Badge>
                        </div>
                        <p className="text-gray-600">
                          EcoStyle is looking for lifestyle creators who can
                          showcase their sustainable fashion line to
                          environmentally conscious audiences. Their products
                          include eco-friendly clothing, accessories, and home
                          goods.
                        </p>
                  ...
                  <CardContent className="p-6">
                    <div className="flex flex-col md:flex-row gap-6">
                      ...
                      <div className="flex-1 space-y-2">
                        ...
                        <p className="text-gray-600">
                          TechGadgets is seeking tech-savvy creators to review
                          and showcase their new line of smart home products.
                          They're looking for in-depth reviews that highlight
                  ...
                  <CardContent className="p-6">
                    <div className="flex flex-col md:flex-row gap-6">
                      ...
                      <div className="flex-1 space-y-2">
                        ...
                        <p className="text-gray-600">
                          FitLife is looking for health and fitness creators to
                          promote their new line of plant-based supplements.
                          They want authentic content showing how their products
