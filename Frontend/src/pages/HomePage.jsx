...
//                 </div>
//                 <h3 className="text-xl font-bold">AI-Driven Sponsorship Matchmaking</h3>
...
//                 </div>
//                 <h3 className="text-xl font-bold">Creator Collaboration Hub</h3>
//                 <p className="text-muted-foreground">
...
//                 </div>
//                 <h3 className="text-xl font-bold">AI-Based Pricing Optimization</h3>
//                 <p className="text-muted-foreground">
...
//                 </div>
//                 <h3 className="text-xl font-bold">Negotiation & Contract Assistant</h3>
//                 <p className="text-muted-foreground">
...
//                 </div>
//                 <h3 className="text-xl font-bold">ROI Tracking</h3>
//                 <p className="text-muted-foreground">
