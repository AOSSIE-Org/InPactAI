                        ...
                        <div className="p-8">
                            ...
                            <form onSubmit={handleSubmit} className="space-y-6">
                                        ...
                                        <div className="mt-2 space-y-2">
                                            ...
                                            <ul className="text-xs space-y-1 text-gray-600 dark:text-gray-400 mt-2">
                                                <li className="flex items-center">
                                                    <span
                                                        className={`mr-1 ${password.length >= 8
                                                                ? "text-green-500"
                                                                : "text-gray-400"
                                                            }`}
                                                    >
                                                ...
                                                <li className="flex items-center">
                                                    <span
                                                        className={`mr-1 ${/[A-Z]/.test(password)
                                                                ? "text-green-500"
                                                                : "text-gray-400"
                                                            }`}
                                                    >
                                                ...
                                                <li className="flex items-center">
                                                    <span
                                                        className={`mr-1 ${/[0-9]/.test(password)
                                                                ? "text-green-500"
                                                                : "text-gray-400"
                                                            }`}
                                                    >
                                                ...
                                                <li className="flex items-center">
                                                    <span
                                                        className={`mr-1 ${/[^A-Za-z0-9]/.test(password)
                                                                ? "text-green-500"
                                                                : "text-gray-400"
                                                            }`}
                                                    >
                                ...
                                <div className="space-y-2">
                                    ...
                                    <div className="relative">
                                        <input
                                            ...
                                            required
                                            className={`w-full px-4 py-3 rounded-lg border focus:outline-none focus:ring-2 focus:ring-purple-500 dark:focus:ring-purple-400 focus:border-transparent bg-white dark:bg-gray-700 text-gray-900 dark:text-white transition-all duration-200 ${confirmPassword && password !== confirmPassword
                                ...
                                <button
                                    ...
                                    className={`w-full py-3 px-4 bg-purple-600 hover:bg-purple-700 focus:ring-purple-500 focus:ring-offset-purple-200 text-white transition ease-in duration-200 text-center text-base font-semibold shadow-md focus:outline-none focus:ring-2 focus:ring-offset-2 rounded-lg ${isLoading ||
                                            (!!confirmPassword && password !== confirmPassword)
